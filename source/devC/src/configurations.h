...
#define CONFIGURATIONS_MINIMUM_COMPUTATION_GROUP 14 //!< n; number of nodes in computation group; never set value lower than 3!
#define CONFIGURATIONS_SHARES_THRESHOLD 9 //!< 0: maximum security, all shares are needed for reconstruction; value will be ignored if >n/2
...
#define CONFIGURATIONS_MAXIMUM_COMPUTATION_GROUP 14 //!< set to same value as minimum for constant group -> better performance
